    ...
    <section class="oem sub_page">
        <div class="left_fix_menu">
            ...
            <div class="sub_gnb_menu">
                <a href="../sub/oem.php">OEM 생산</a>
                <a href="../sub/production.php" class="on">자체 생산</a>
            </div>
        ...
        <div class="inner950">
            <h2>자체 생산</h2>
            <?php
            $sql="SELECT * FROM `self` ORDER BY num ASC";
            ...
            <div class="oem_contents">
                <?php if(($no % 2)==1) { ?>
                <img src="../img/self/<?php echo $thumb?>" alt="">
                <?php  } ?>
                <div class="contents">
