        ...
        <div class="inner1024">
            ...
            <div class="notice_table">
                ...
                if($type=="t"){
                    ...
                    $w=" WHERE contents LIKE '%$search%'";
                } else if($type=="tc"){
                    $w=" WHERE title LIKE '%$search%' OR contents LIKE '%$search%'";
                }
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM notice{$w}";
                ...
                $sql="SELECT * FROM notice{$w} ORDER BY num DESC LIMIT $limit, $list";
                ...
                <a href="notice_detail.php?num=<?php echo $num?>">
                    <p><?php echo $no--;?></p>
                    <p><span><?php echo $title?></span></p><!--<img src="../img/hot.png" alt=""> -->
                    <p>관리자</p>
