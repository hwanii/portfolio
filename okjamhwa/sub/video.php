    ...
    <section class="video sub_page">
        ...
        <div class="inner1024">
            ...
            <div class="video_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM video";
                ...
                $sql="SELECT * FROM video ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="video_detail.php?num=<?php echo $num?>">
                    <img src="../img/video/<?php echo $thumb?>" alt="">
                    <p><?php echo $title?></p>
                </a>
                <?php } ?>
            </div>
