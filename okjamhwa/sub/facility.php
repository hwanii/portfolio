    ...
    <section class="plant sub_page">
        ...
        <div class="inner950">
            ...
            <div class="plant_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM facility";
                ...
                $sql="SELECT * FROM facility ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="facility_detail.php?num=<?php echo $num?>" class="contents">
                    <img src="../img/facility/<?php echo $thumb?>" alt="">
                    <p><?php echo $title?></p>
                </a>
                <?php } ?>
            </div>
