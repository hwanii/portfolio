    ...
    <section class="jam_detail sub_page">
        <div class="left_fix_menu">
            ...
            <div class="sub_gnb_menu">
                ...
                <a href="../sub/juice.php">쥬스</a>
                <a href="../sub/tea.php" class="on">전통차</a>
            </div>
        ...
        $hSql="UPDATE tea SET hit=hit+1 WHERE num='$num'";
        $hRes=mysqli_query($conn, $hSql);

        $sql="SELECT * FROM tea WHERE num='$num'";
        ...
        <div class="inner950">
            <div class="jam_detail_contents">
                <img src="../img/tea/<?php echo $thumb?>" alt="">
                <div class="right">
