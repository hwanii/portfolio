...
<body>
    ...
    <section class="notice sub_page">
        ...
        <div class="inner1024">
            ...
            <a href="notice.php" class="go_list">목록</a>
            <?php
            $pSql="SELECT * FROM notice WHERE num < '$num' ORDER BY num DESC LIMIT 1";
            $pRes=mysqli_query($conn, $pSql);
            $pRow=mysqli_fetch_array($pRes);
            $prev=$pRow['num'];
            $pTit=$pRow['title'];
            
            $nSql="SELECT * FROM notice WHERE num > '$num' ORDER BY num ASC LIMIT 1";
