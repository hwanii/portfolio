...
<title>(주)대원로지스틱</title>
<meta name="description" content="(주)대원로지스틱은 종합물류서비스를 제공하는 기업으로, 기업과 고객의 운송영역에 믿음과 신뢰를 주는 기업입니다.">
<meta property="og:type" content="website" />
<meta property="og:image" content="<?php echo $meta?>img/opengraph-img.jpg" />
<meta property="og:title" content="대원로지스틱" />
<meta property="og:description" content="(주)대원로지스틱은 종합물류서비스를 제공하는 기업으로, 기업과 고객의 운송영역에 믿음과 신뢰를 주는 기업입니다." />
<meta property="og:url" content="http://highklass.co.kr/daewon" />
...
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo $meta?>favicon/<?php echo $meta?>favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="<?php echo $meta?>favicon/<?php echo $meta?>favicon-96x96.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo $meta?>favicon/<?php echo $meta?>favicon-16x16.png">
