...
<body>
    ...
    <section class="menu_flow">
        <div class="inner">
            <select dir="rtl" onchange="window.open(value,'_self');">
                ...
                <option selected value="../sub/vehicle.php">차량 현황</option>
            </select>
            <ul>
                <li>HOME</li>
                <li>시설/장비/차량현황</li>
    ...
    <section class="facility">
        <div class="contents_inner">
            <div class="sub_title">
                <h2>차량 현황</h2>
                <p>물류운송차량 총 106대 보유중</p>
            </div>
            <div class="contents">
                <?php
                $sql="SELECT * FROM bo_car WHERE file_4='물류운송차량' ORDER BY num ASC";
                ...
                ?>
                <div>
                    <img src="../img/<?php echo ($thumb) ? "car/".$thumb : "no-image.png"?>" alt="">
                    <p><?php echo $title?></p>
                </div>
                <?php } ?>
            </div>
            ...
            <div class="contents">
                <?php
                $sql="SELECT * FROM bo_car WHERE file_4='물류운영장비' ORDER BY num ASC";
                $res=mysqli_query($conn, $sql);
                while($row=mysqli_fetch_array($res)){
                    $title=$row['title'];
                    $thumb=$row['thumbnail'];
