    ...
    <section class="announcement">
        <div class="inner">
            ...
            <div class="an_table">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM `ir`";
                ...
                $no=$total_count-$limit;
                    //$limit+1;
                $lSql="SELECT * FROM ir ORDER BY write_time DESC LIMIT $limit, $list";
                ...
                while($lRow=mysqli_fetch_array($lRes)){
                    ...
                    $num=$lRow['num'];
                ?>
                <a href="ir_detail.php?no=<?php echo $no?>&num=<?php echo $num?>" class="contents">
            ...
            <div class="page_pagination">
                ...
                if($block > 1){
                ?>
                <a href="ir.php?page=1" class="pprev"><img src="../img/pprev.png"></a>
                <a href="ir.php?page=<?php echo $b_start_page - 1 ?>" class="prev"><img src="../img/prev.png"></a>
                <?php
                }
                ?>
                <div class="num">
                    ...
                    for($i=$b_start_page;$i<=$b_end_page;$i++){
                        ...
                        <?php } else { ?>
                        <a href="ir.php?page=<?php echo $i ?>"><p><?php echo $i?></p></a>
                    <?php } 
                    } ?>
                </div>
                <?php
                ...
                ?>
                <a href="ir.php?page=<?php echo $b_end_page + 1 ?>" class="next"><img src="../img/nnext.png"></a>
                <a href="ir.php?page=<?php echo $total_page ?>" class="nnext"><img src="../img/next.png"></a>
                <?php } ?>
            </div>
        </div>
    </section>
