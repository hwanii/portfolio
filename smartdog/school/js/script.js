$(document).ready(function () {
    ...
    $(".space .contents_box .left li").click(function(){
        $(".space .contents_box .left li").removeClass("on");
        $(this).addClass("on");

        let spli = $(this).index();

        $(".space .contents_box .right .space_slide").removeClass("active");
        $(".space .contents_box .right .space_slide").eq(spli).addClass("active");
    });
