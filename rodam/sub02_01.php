...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('./admin/img/pc_sub_banner/<?php echo $bnRow['file1']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>여드름 패인 흉터</h2>
            <p>CORA THERAPY</p>
    ...
    <section class="intro">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="pimple_category">
                <a href="sub02_01.php" class="on">부위별 여드름 패인 흉터</a>
                <a href="sub02_02.php">모양별 여드름 패인 흉터</a>
            </div>
            <div class="top_txt diet_txt_box" data-aos="fade-up">
                <p>여드름 패인 흉터 <b>치료, 부위별로 확인하세요</b></p>
            </div>
            <div class="pimple_box" data-aos="fade-up">
                <div class="left">
    ...
    <section class="report">
        <div class="inner" data-aos="fade-up">
            ...
            <ul class="case_category" data-aos="fade-up">
            ...
            <div class="case_box">
                <div class="report_contents active">
                    <?php
                    $nSql="SELECT * FROM sub_page_bna WHERE `type`='type01' AND part='part01' ORDER BY num DESC LIMIT 4";
