    ...
    <div class="header_slide_inner">
        <div class="swiper-container header_slide">
            <div class="swiper-wrapper">
                <?php
                $sSql="SELECT * FROM slide_pc_header WHERE `location`='헤더' ORDER BY num ASC";
...
<?php
$hsSql="SELECT * FROM branch_contact WHERE branch='$rb'";
$hsRes=mysqli_query($conn, $hsSql);
$hsRow=mysqli_fetch_array($hsRes);
?>
<div class="right_fix">
    <a href="<?php echo $hsRow['youtube']?>" target="_blank">
    ...
    <a href="<?php echo $hsRow['kakao']?>" target="_blank">
