...
<body>
    ...
    <section class="sub_banner" style="background: url(img/sub-banner09.png) no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>전후 사진</h2>
            <p>BEFORE &amp; AFTER</p>
    ...
    <div class="report_fix">
        <div class="top"></div>
        <div class="contents">
            <a href="sub09.php" class="on">전체보기</a>
            <a href="sub09_01.php">여드름 흉터</a>
    ...
    <section class="report" style="background-color: #fff;">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_link">
                <a href="sub09.php" class="on">전체보기</a>
                <a href="sub09_01.php">여드름 패인 흉터</a>
                <a href="sub09_02.php">수두·대상포진 흉터</a>
                <a href="sub09_03.php">수술·성형 흉터</a>
                <a href="sub09_04.php">기타 패인 흉터</a>
                <a href="sub09_05.php">모공·여드름</a>
