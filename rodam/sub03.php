...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('./admin/img/pc_sub_banner/<?php echo $bnRow['file2']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>수두ㆍ대상포진 흉터</h2>
            <p>CORA THERAPY</p>
    ...
    <section class="report">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_contents">
                <?php
                $nSql="SELECT * FROM sub_page_bna WHERE `type`='type02' ORDER BY num DESC LIMIT 4";
