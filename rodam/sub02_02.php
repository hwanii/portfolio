...
<body>
    ...
    <section class="intro">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="pimple_box01" data-aos="fade-up">
                <div class="left">
                    <div class="contents on">
                        <div><span></span></div>
                        <p>박스카흉터 (Boxcar scar)</p>
                    </div>
                    <div class="contents">
                        <div><span></span></div>
                        <p>아이스픽 흉터 (Icepick scar)</p>
                    </div>
                    <div class="contents">
                        <div><span></span></div>
                        <p>롤링형 흉터 (Rolling scar)</p>
                    </div>
                </div>
                <div class="right">
        ...
        <div class="inner" data-aos="fade-up">
            ...
            <div class="case_box">
                <div class="report_contents active">
                    <?php
                    $nSql="SELECT * FROM sub_page_bna WHERE `type`='type01' AND part='part05' ORDER BY num DESC LIMIT 4";
