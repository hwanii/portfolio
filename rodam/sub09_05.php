...
<body>
    ...
    <div class="report_fix">
        ...
        <div class="contents">
            ...
            <a href="sub09_05.php" class="on">모공·여드름</a>
        </div>
    ...
    <section class="report" style="background-color: #fff;">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM bna WHERE `type`='type05' OR `type`='type05'";
                ...
                $sql="SELECT * FROM bna WHERE `type`='type05' OR `type`='type05' ORDER BY num DESC";
