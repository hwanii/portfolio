...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('./admin/img/pc_sub_banner/<?php echo $bnRow['file9']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>새살침 코라테라피</h2>
            <p>CORA THERAPY</p>
    ...
    <!-- <section class="watch" id="youtube" data-aos="fade-up">
        ...
        <?php
        $ySql="SELECT * FROM sub_youtube WHERE `page`='sub00'";
