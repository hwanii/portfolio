...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('../admin/img/mobile_sub_banner/<?php echo $bnRow['file8']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>전후 사진</h2>
            <p>BEFORE &amp; AFTER</p>
    ...
    <div class="report_fix">
        <div class="top"></div>
        <div class="contents">
            <a href="../m/sub09.php">전체보기</a>
            <a href="../m/sub09_01.php">여드름 흉터</a>
            <a href="../m/sub09_02.php">수두·대상포진 흉터</a>
            <a href="../m/sub09_03.php">수술·성형 흉터</a>
            <a href="../m/sub09_04.php">기타 패인 흉터</a>
            <a href="../m/sub09_05.php" class="on">모공·여드름</a>
        </div>
    ...
    <section class="report" style="background-color: #fff;">
        <div class="inner" data-aos="fade-up">
            ...
            <p class="ba_txt">
                ...
                치료 사진 사례는 의료법상 회원 가입 또는<br class="br480"> 로그인 후 열람하실 수 있습니다.<br>
            ...
            <div class="report_link">
                <a href="../m/sub09.php">전체보기</a>
                <a href="../m/sub09_01.php">여드름 패인 흉터</a>
                <a href="../m/sub09_02.php">수두·대상포진 흉터</a>
                <a href="../m/sub09_03.php">수술·성형 흉터</a>
                <a href="../m/sub09_04.php">기타 패인 흉터</a>
                <a href="../m/sub09_05.php" class="on">모공·여드름</a>
            ...
            <div class="report_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM bna WHERE `type`='type05'";
                ...
                $sql="SELECT * FROM bna WHERE `type`='type05' ORDER BY num DESC";
                ...
                <div class="box_contents no_login" data-aos="fade-up">
                    ...
                    <div class="contents">
                        <?php if(!isset($user)){ ?>
                        <div class="login_bg" style="display: block;"><h2>로그인 후 이용이 가능합니다.</h2></div>
                        <?php } ?>
            ...
            <p class="re_bot_txt">치료 중에는 붉은기, 붓기, 멍, 염증성 트러블이 발생할 수 있으며,<br class="br410">환자의 치료결과는 환자의 상태, 치료 방법 등에 따라 차이가 있을 수 있습니다.</p>
        </div>
    </section>
