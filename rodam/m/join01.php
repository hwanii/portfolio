...
<body>
    ...
    <section class="join">
        ...
        <div class="login_box login_underLine">
            ...
            <div class="mypage_box">
                <div class="contents phone">
                    <p>가입자명</p>
                    <div class="right" style="flex-direction: column; align-items: unset;">
                        <input type="text" name="name" placeholder="가입자명" onkeydown="checkSpacebar()" required>
                        <div class="label_contents01" style="width: 100%;">
                            <p>가입자 성별</p>
                            <div>
                                <label>
        ...
        <div class="bottom_btn" style="display: flex; justify-content: center; gap: 10px;">
            <div class="auto-no">
                <div>
                    <h3>자동 등록 방지</h3>
