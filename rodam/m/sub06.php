...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('../admin/img/mobile_sub_banner/<?php echo $bnRow['file5']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>여드름 / 여드름자국</h2>
            <p>ACNE VULGARIS</p>
    ...
    <section class="report">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="pimple_box01 acne_box01">
                <div class="left">
            ...
            <div class="report_contents">
                <?php
                $nSql="SELECT * FROM sub_page_bna WHERE `type`='type05' ORDER BY num DESC LIMIT 3";
    ...
    <section class="solution">
        <div class="inner">
            ...
            <div class="ance_simple_img">
                <img src="../img/ance-inner01.png">
                <img src="../img/ance-inner02.png">
            </div>
            <div class="ance_check_box">
            ...
            <p class="eat_p">
                여드름을 꾸준히 압출해도 계속 나는 이유는<br>
                내부적으로 피지분비와 염증을 조절하지 못했기 때문입니다.<br>
                로담의 여드름 치료 한약 &#60;피지 싹클린(여치음)&#62;으로<br>
                피지분비, 염증, 여드름 스트레스에서 벗어나시기 바랍니다.<br>
                장기 복용에도 간독성 걱정 없는 천연생약으로<br>
                부작용 걱정 없이 언제든 복용하실 수 있습니다.<br>
                미성년자, 가임기 여성 모두 안심하고<br>
                드실 수 있는 한의사의 처방 한약입니다. 
            </p>
        </div>
    </section>
    <section class="out_treat">
        <div class="inner">
            ...
            <div class="contents reverse_con">
                <div class="txt_box">
                    <h2>02</h2>
                    <h3>천연재생침</h3>
                    <p>
    ...
    <section class="charge sub_change01 sub06_charge">
        <div class="inner">
            ...
            <div class="cp_contents cp_contents02">
                ...
                <h4 class="font48" data-aos="fade-up">새살침 코라테라피 <span>얼굴 패인</span> 흉터 시술 과정</h4>
                <div class="contents">
