...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('../admin/img/mobile_sub_banner/<?php echo $bnRow['file2']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>수두ㆍ대상포진 흉터</h2>
            <p>CORA THERAPY</p>
    ...
    <section class="intro">
        <div class="inner">
            ...
            <?php
            $sql="SELECT * FROM sub_scar WHERE cate='introducing'";
            ...
            <div class="intro_contents">
                <div class="contents">
                    <div class="left" data-aos="fade-up">
                        ...
                        <p>수두 흉터의 가장 큰 특징<br> <b>오래된 흉터 라는 점</b></p>
                        <span>
                            치료가 안되는 흉터라고 생각하시거나, 다른 치료를 해봐도<br>
                            효과를 보지 못하셔서 짧게는 5년, 길게는 10년에서 30년<br>
                            까지 치료를 하지 않고 방치해두고 계십니다.
                        </span>
                    </div>
                        ...
                        <div class="swiper-container intro_slide intro_slide01">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="../admin/img/scar/introducing/<?php echo $row['text'.$i]?>">
                                </div>
                                <?php } ?>
                            </div>
                ...
                <div class="contents">
                    <div class="left" data-aos="fade-up">
                        ...
                        <p>대상포진 흉터의 가장 큰 특징<br> <b>불규칙한 모양이라는 점</b></p>
                        <span>
                            치료가 안된다는 말을 들으셨거나,<br>
                            어떻게 치료하면 좋을지 몰라서<br>
                            그냥 치료를 포기하신 경우가 많습니다.
                        </span>
                    </div>
                    <div class="right" data-aos="fade-up">
    ...
    <section class="report">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_contents">
                <?php
                $nSql="SELECT * FROM sub_page_bna WHERE `type`='type02' ORDER BY num DESC LIMIT 3";
                ...
                <div class="box_contents no_login" data-aos="fade-up">
                    ...
                    <div class="contents">
                        <div class="report_branch"><h2>강남 본점</h2></div>
                        <div class="top_contents">
                            <img src="../admin/img/sub_page_bna/type02/<?php echo $before?>">
                            <img src="../admin/img/sub_page_bna/type02/<?php echo $after?>">
                        </div>
    ...
    <section class="point">
        <div class="inner">
            ...
            <?php
            $sql="SELECT * FROM sub_scar WHERE cate='point'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="top_txt" data-aos="fade-up">
                ...
                <p>수두·대상포진 흉터치료 <b>가장 중요한 요소</b></p>
                <span>수두·대상포진 흉터의 형태와<br> 환자의 피부 특성을 고려하는 것이</span>
                <h3>가장 중요합니다!</h3>
            </div>
            <div class="point_contents">
                <div class="left" data-aos="fade-up">
                    <h2>1</h2>
                    <h3>수두·대상포진 흉터 형태 파악</h3>
                    <p>흉터의 모양 ㅣ 위치 ㅣ 패인 정도</p>
                    <div class="bottom">
                        <div>
                            <img src="../admin/img/scar/point/<?php echo $row['text1'];?>">
                            <span>수두흉터</span>
                        </div>
                        <div>
                            <img src="../admin/img/scar/point/<?php echo $row['text2'];?>">
                            <span>대상포진흉터</span>
                        </div>
                    </div>
                </div>
                <div class="right" data-aos="fade-up">
                    ...
                    <img src="../admin/img/scar/point/<?php echo $row['text3'];?>">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="charge sub_change01">
        <div class="inner">
            ...
            $pSql="SELECT * FROM sub_scar WHERE cate='process'";
            ...
            <div class="cp_contents cp_contents02">
                ...
                <h4 data-aos="fade-up">새살침 코라테라피 <span>수두·대상포진</span> 흉터 시술 과정</h4>
                <div class="contents">
                ...
                <div class="bottom">
                    <img src="./admin/img/scar/process/<?php echo $pRow['text4'];?>" data-aos="fade-left">
                    <img src="./admin/img/scar/process/<?php echo $pRow['text5'];?>" data-aos="fade-right">
                </div>
            </div>
    ...
    <section class="faq sub_faq">
        <div class="inner">
            <div class="sub_title" data-aos="fade-up">
                <h2>F A Q</h2>
                <div class="title_line"></div>
                <p>수두·대상포진 흉터 자주 묻는 질문들 입니다.</p>
            </div>
            <div class="faq_contents" data-aos="fade-up">
                <?php
                $fSql="SELECT * FROM sub_faq WHERE `page`='sub02'";
