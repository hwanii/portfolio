...
<body>
    ...
    <div class="report_fix">
        ...
        <div class="contents">
            ...
            <a href="../m/sub09_03.php" class="on">수술·성형 흉터</a>
            <a href="../m/sub09_04.php">기타 패인 흉터</a>
            <a href="../m/sub09_05.php">모공·여드름</a>
        </div>
    ...
    <section class="report" style="background-color: #fff;">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM bna WHERE `type`='type03'";
                ...
                $sql="SELECT * FROM bna WHERE `type`='type03' ORDER BY num DESC";
