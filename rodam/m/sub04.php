...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('../admin/img/mobile_sub_banner/<?php echo $bnRow['file3']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>수술ㆍ성형 흉터</h2>
            <p>CORA THERAPY</p>
    ...
    <section class="report">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_contents">
                <?php
                $nSql="SELECT * FROM sub_page_bna WHERE `type`='type03' ORDER BY num DESC LIMIT 3";
    ...
    <section class="charge sub_change01">
        <div class="inner">
            ...
            <div class="cp_contents cp_contents02">
                ...
                <h4 data-aos="fade-up" style="letter-spacing: -1px;">새살침 코라테라피 <span>수술ㆍ성형</span> 흉터 시술 과정</h4>
                <div class="contents" style="letter-spacing: -1px;">
