...
<body>
    ...
    ?>
    <section class="sub_banner" style="background: url('../admin/img/mobile_sub_banner/<?php echo $bnRow['file4']?>') no-repeat center/cover;">
        <div class="bg"></div>
        <div class="txt_box">
            <h2>기타 얼굴 패인 흉터</h2>
            <p>CORA THERAPY</p>
            ...
            <div class="intro_contents">
                <div class="contents">
                    <div class="left" data-aos="fade-up">
                        ...
                        <p style="letter-spacing: -2px;">얼굴 패인 흉터의 가장 큰 특징<br> <b>오래되거나 언제 생겼는지 모른다는 점</b></p>
                        <span style="letter-spacing: -1px;">
                            얼굴 패인흉터는 치료가 안된다고 알고 계시고, 이곳 저곳을<br>
    ...
    <section class="report">
        <div class="inner" data-aos="fade-up">
            ...
            <div class="report_contents">
                <?php
                $nSql="SELECT * FROM sub_page_bna WHERE `type`='type04' ORDER BY num DESC LIMIT 3";
    ...
    <section class="charge sub_change01">
        <div class="inner">
            ...
            <div class="cp_contents cp_contents02">
                ...
                <div class="contents">
                    <div data-aos="fade-up" style="letter-spacing: -1px;">
                        <h2>시술 대상</h2>
                        <div class="line"></div>
