    ...
    <div class="flow">
        <div class="inner">
            <div class="left">
                ...
                <div class="title">
                    <ul>
                        <li><a href="../sub/business.php">사업분야</a></li>
                        <li class="on"><a href="../sub/licenses.php">허가사항</a></li>
                    </ul>
                </div>
            </div>
            <div class="right">HOME&nbsp;&nbsp;>&nbsp;&nbsp;BUSINESS&nbsp;&nbsp;>&nbsp;&nbsp;허가사항</div>
        </div>
    </div>
    ...
    <section class="licenses">
        <div class="inner">
            ...
            <div class="li-box">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM licenses";
                ...
                $sql="SELECT * FROM licenses ORDER BY num ASC LIMIT $limit, $list";
                ...
                <a href="javascript:void(0)">
                    <img src="../img/licenses/<?php echo $thumb?>" alt="">
                    <p><?php echo $title?></p>
                </a>
                <?php } ?>
            </div>
