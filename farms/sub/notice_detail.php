            ...
            <div class="left">
                ...
                <div class="title">
                    <ul>
                        ...
                        <li><a href="../sub/board.php">게시판</a></li>
                    </ul>
                </div>
            </div>
            <div class="right">HOME&nbsp;&nbsp;>&nbsp;&nbsp;COMMUNITY&nbsp;&nbsp;>&nbsp;&nbsp;공지사항</div>
        </div>
    </div>
    <?php
    $num=$_GET['num'];
        ...
        <div class="inner">
            ...
            <div class="attached">
                <div>
                    ...
                    <a id="down" href="../img/file/notice/<?php echo $file?>" style="display:none" download></a>
                </div>
            </div>
            <?php } ?>
            <div class="post-bot">
                ...
                <div class="center"><a href="notice.php">리스트</a></div>
