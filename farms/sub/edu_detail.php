...
<body>
            ...
            <div class="left">
                ...
                <div class="title">
                    <ul>
                        ...
                        <li class="on"><a href="../sub/edu.php">교육, 분석용 배지</a></li>
                        <li><a href="../sub/micro.php">미생물 배양용 분말 배지</a></li>
                        <li><a href="../sub/etc.php">기타</a></li>
                    </ul>
                </div>
            </div>
            <div class="right">HOME&nbsp;&nbsp;>&nbsp;&nbsp;PRODUCT&nbsp;&nbsp;>&nbsp;&nbsp;교육, 분석용 배지</div>
        </div>
    </div>
    <?php
    $num=$_GET['num'];

    $hSql="UPDATE pro_edu SET hit=hit+1 WHERE num='$num'";
    $hRes=mysqli_query($conn, $hSql);

    $sql="SELECT * FROM pro_edu WHERE num='$num'";
    ...
    <section class="con-det">
        <div class="inner">
            ...
            <div class="post-bot">
                <?php
                $pSql="SELECT * FROM pro_edu WHERE num<'$num' ORDER BY num DESC LIMIT 1";
                $pRes=mysqli_query($conn, $pSql);
                $pRow=mysqli_fetch_array($pRes);
                $prev=($pRow['num']) ? $_SERVER['PHP_SELF']."?num=".$pRow['num'] : "javascript:alert('이전 글이 없습니다..')";

                $nSql="SELECT * FROM pro_edu WHERE num>'$num' ORDER BY num ASC LIMIT 1";
                ...
                <div class="center"><a href="edu.php">리스트</a></div>
