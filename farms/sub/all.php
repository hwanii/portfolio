...
<body>
    ...
    <section class="bio">
        <div class="inner">
            ...
            <div class="box">
                <?php
                $sql="SELECT * FROM pro_bio UNION ALL SELECT * FROM pro_edu UNION ALL SELECT * FROM pro_micro UNION ALL SELECT * FROM pro_etc";
                ...
                ?>
                <div>
                    <a href="all_detail.php?num=<?php echo $num?>&type=<?php echo $type?>">
                        <img src="../img/product/<?php echo $type?>/<?php echo $thumb?>" alt="">
