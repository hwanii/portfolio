...
<body>
    ...
    <section class="con-det">
        <div class="inner">
            <h2 class="comu"><?php echo $title?></h2>
            <div class="post-box"><?php echo $contents?></div>
            <?php if($file){ ?>
            <div class="attached">
                <div>
                    <img src="../img/document.png" alt="" onclick="document.querySelector('#down').click();">
                    <p onclick="document.querySelector('#down').click();"><?php echo $file?></p>
                    <a id="down" href="../img/file/board/<?php echo $file?>" style="display:none" download></a>
                </div>
            </div>
            <?php } ?>
            <div class="modi">
            ...
            <div class="modi-pop">
                <form method="POST" action="confirm.php" target="ifrm">
            ...
            <div class="post-bot">
                <?php
                $pSql="SELECT * FROM bo_board WHERE num<'$num' ORDER BY num DESC LIMIT 1";
                $pRes=mysqli_query($conn, $pSql);
                $pRow=mysqli_fetch_array($pRes);
                $prev=($pRow['num']) ? $_SERVER['PHP_SELF']."?num=".$pRow['num'] : "javascript:alert('이전 글이 없습니다..')";

                $nSql="SELECT * FROM bo_board WHERE num>'$num' ORDER BY num ASC LIMIT 1";
                ...
                <div class="center"><a href="board.php">리스트</a></div>
