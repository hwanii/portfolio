...
<body>
    ...
    <div class="flow">
        <div class="inner">
            <div class="left">
                ...
                <div class="title">
                    <ul>
                        ...
                        <li class="on"><a href="../sub/bio.php">생물학적 제제</a></li>
            ...
            <div class="right">HOME&nbsp;&nbsp;>&nbsp;&nbsp;PRODUCT&nbsp;&nbsp;>&nbsp;&nbsp;생물학적 제제</div>
        </div>
    </div>
    <?php
    $num=$_GET['num'];

    $hSql="UPDATE pro_bio SET hit=hit+1 WHERE num='$num'";
    $hRes=mysqli_query($conn, $hSql);

    $sql="SELECT * FROM pro_bio WHERE num='$num'";
    ...
    <section class="con-det">
        <div class="inner">
            ...
            <div class="post-bot">
                ...
                <div class="center"><a href="bio.php">리스트</a></div>
