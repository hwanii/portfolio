...
<body>
    ...
    <div class="flow">
        <div class="inner">
            <div class="left">
                ...
                <div class="title">
                    <ul>
                        ...
                        <li class="on"><a href="../sub/history.php">연혁</a></li>
            ...
            <div class="right">HOME&nbsp;&nbsp;>&nbsp;&nbsp;COMPANY&nbsp;&nbsp;>&nbsp;&nbsp;연혁</div>
        </div>
    </div>
        ...
        <div class="inner">
            ...
            <div class="box">
                ...
                <div class="con">
                    ...
                    <ul>
                        <?php
                        $mSql="SELECT DISTINCT DATE_FORMAT(datetime, '%m') AS month FROM `history` WHERE DATE_FORMAT(datetime, '%Y')='$year' ORDER BY datetime ASC";
                        ...
                        <li>
                            ...
                            <p>
                            <?php
                            $tSql="SELECT * FROM `history` WHERE DATE_FORMAT(datetime, '%Y')='$year' AND DATE_FORMAT(datetime, '%m')='$month' ORDER BY num ASC";
