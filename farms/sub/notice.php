...
<body>
    ...
    <div class="notice">
        <div class="inner">
            ...
            $pSql="SELECT COUNT(*) AS cnt FROM bo_notice";
            ...
            $sql="SELECT * FROM bo_notice ORDER BY num DESC LIMIT $limit, $list";
            ...
            ?>
            <a href="notice_detail.php?num=<?php echo $num?>" class="board-con">
