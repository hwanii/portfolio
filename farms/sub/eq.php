            ...
            <div class="left">
                ...
                <div class="title">
                    <ul>
                        ...
                        <li class="on"><a href="../sub/eq.php">보유장비</a></li>
                        <li><a href="../sub/map.php">오시는 길</a></li>
                    </ul>
                </div>
            </div>
            <div class="right">HOME&nbsp;&nbsp;>&nbsp;&nbsp;COMPANY&nbsp;&nbsp;>&nbsp;&nbsp;보유장비</div>
        </div>
    </div>
    ...
    <section class="eq">
        <div class="inner">
            ...
            <div class="dev">
                ...
                <div class="img-box">
                    <?php
                    $rSql="SELECT * FROM eq_research ORDER BY num ASC";
                    ...
                    <div>
                        <a href="javascript:void(0)">
                            <img src="../img/eq/research/<?php echo $rThumb?>" alt="">
                            <p>
                                <?php echo $rTit?>
                            </p>
                        </a>
            ...
            <div class="test">
                ...
                <div class="img-box">
                    <?php
                    $tSql="SELECT * FROM eq_test ORDER BY num ASC";
                    $tRes=mysqli_query($conn, $tSql);
                    while($tRow=mysqli_fetch_array($tRes)){
                        $tTit=$tRow['title'];
                        $tThumb=$tRow['thumbnail'];
                    ?>
                    <div>
                        <a href="javascript:void(0)">
                            <img src="../img/eq/test/<?php echo $tThumb?>" alt="">
                            <p>
                                <?php echo $tTit?>
                            </p>
                        </a>
