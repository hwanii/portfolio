...
<body>
    ...
    <main class="update" data-aos="fade-up">
        ...
        <div class="up-cate">
            ...
            <a href="update-01.php">주제1</a>
            <a href="update-02.php">주제2</a>
            <a href="update-03.php">주제3</a>
            <a href="update-04.php">주제4</a>
            <a href="update-05.php" class="on">주제5</a>
        </div>
        <div class="up-box">
            <?php
            $sql="SELECT * FROM bo_update WHERE file_1='주제5' ORDER BY num DESC";
