...
<body>
    ...
    <div class="wow-cate wow-cate02">
        <ul>
            ...
            ?>
            <li><a href="../sub/product01.php"><?php echo $array[0]?></a></li>
            <li><a href="../sub/product02.php"><?php echo $array[1]?></a></li>
            <li class="on"><a href="../sub/product03.php"><?php echo $array[2]?></a></li>
    ...
    <section class="product">
        ...
        <div class="inner">
            ...
            <div class="de-contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM product WHERE `type`='cate3'{$s}";
                ...
                $sql="SELECT * FROM product WHERE `type`='cate3'{$s} ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="product_detail.php?type=cate3&num=<?php echo $num?>">
                    <img src="../img/product/cate3/thumb/<?php echo $thumb?>" alt="">
                    <p><?php echo $title?></p>
                </a>
                <?php } ?>
            </div>
