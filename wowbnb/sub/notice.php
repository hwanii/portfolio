    ...
    <section class="notice">
        <div class="inner">
            ...
            while($row=mysqli_fetch_array($res)){
                ...
                $num=$row['num'];
            ?>
            <a href="notice_detail.php?num=<?php echo $num?>" class="board-content board-content-top">
                <p><?php echo $no--; ?></p>
                <p><?php echo $title?><img src="../img/hot.gif" alt="" style="<?php echo ($hot>3) ? "display:none" : ""?>"></p>
                <div>
                    <p>관리자</p>
            ...
            <?php } ?>
            <a href="notice.php" class="go-list">리스트</a>
            <div class="page-ch">
                <div class="prev">
                    <?php
                    if($page > 1){
