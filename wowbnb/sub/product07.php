...
<body>
    ...
    <div class="wow-cate wow-cate02">
        <ul>
            ...
            <li class="on"><a href="../sub/product07.php"><?php echo $array[6]?></a></li>
    ...
    <section class="product">
        ...
        <div class="inner">
            ...
            <div class="de-contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM product WHERE `type`='cate7'{$s}";
                ...
                $sql="SELECT * FROM product WHERE `type`='cate7'{$s} ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="product_detail.php?type=cate7&num=<?php echo $num?>">
                    <img src="../img/product/cate7/thumb/<?php echo $thumb?>" alt="">
                    <p><?php echo $title?></p>
                </a>
                <?php } ?>
            </div>
