...
<body>
    ...
    <section class="sub-banner sub03">
        ...
        <div class="txt-box">
            ...
            <p>HOME&nbsp;&nbsp;>&nbsp;&nbsp;CUSTOMER SERVICE&nbsp;&nbsp;>&nbsp;&nbsp;REQUEST</p>
        </div>
    </section>
    <div class="wow-cate wow-cate01">
        <ul>
            <li><a href="../sub/notice.php">공지사항</a></li>
            <li class="on"><a href="../sub/request.php">문의하기</a></li>
            <li><a href="../sub/download.php">자료실</a></li>
        </ul>
    </div>
    <section class="customer-center">
        <div class="inner">
            <form id="counselForm" method="POST" action="counsel.php" enctype="multipart/form-data" target="ifrm">
            <div class="re-contents">
                <div>
                    <p>담당자 / 직책<span>*</span></p>
                    <input type="text" name="manager" required>
                </div>
                <div>
                    <p>연락처<span>*</span></p>
                    <select name="fTel" required>
                ...
                <div>
                    <p>이메일<span>*</span></p>
                    <input type="text" name="email" required>@<input type="text" name="addr" class="emailhost" readonly required>
                    <select class="email_list" name="">
                ...
                <div>
                    <p>첨부파일</p>
                    <span id="sFile"></span>
                    <button type="button" onclick="$('#file').click();" class="file-ch">파일선택</button>
                ...
                <div>
                    ...
                    <div>
                        <p>
                            와우비엔비(이하"회사라 합니다)은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.<br>
                            <br>
                            ...
                            <br>
                            아래와 관련한 개인정보는 수집.이용에 관한 동의일로부터까지 위 이용목적을 위하여 보유.이용됩니다.<br>
                            <br>
                            보유근거 : 전자상거래등에서의 소비자보호에 관한 법률, 신용정보의 이용 및 보호에 관한 법률<br>
                            <br>
                            ...
                            <br>
                            - 필수항목 : 이메일, 휴대전화번호, 자택주소, 자택전화번호, 비밀번호 질문과 답, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록<br>
                            <br>
                            5. 개인정보의 파기<br>
                            <br>
                            원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.<br>
                            <br>
                            -파기절차<br>
                            <br>
                            ...
                            연락처 : 031-273-8481<br>
                            <br>
                            ② 정보주체께서는 회사의 서비스을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 회사는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br>
                            8. 개인정보 처리방침 변경<br>
                            <br>
                        ...
                        <div>
                            ...
                            <p onclick="$('#check1').click();">동의합니다.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="sub-btn">
                <button>등록</button>
                <button type="button" onclick="form_reset()">취소</button>
            </div>
            </form>
        </div>
    </section>
