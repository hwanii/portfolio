...
<body>
    ...
    <div class="wow-cate wow-cate02">
        <ul>
            ...
            <li class="on"><a href="../sub/product06.php"><?php echo $array[5]?></a></li>
    ...
    <section class="product">
        ...
        <div class="inner">
            ...
            <div class="de-contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM product WHERE `type`='cate6'{$s}";
                ...
                $sql="SELECT * FROM product WHERE `type`='cate6'{$s} ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="product_detail.php?type=cate6&num=<?php echo $num?>">
                    <img src="../img/product/cate6/thumb/<?php echo $thumb?>" alt="">
                    <p><?php echo $title?></p>
                </a>
                <?php } ?>
            </div>
