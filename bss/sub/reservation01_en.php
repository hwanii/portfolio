...
<body>
    ...
    <section class="reservation">
        <div class="inner">
            ...
            <input type="hidden" name="res_type" value="ah">
            <input type="hidden" id="air_box" name="air_box" value="0">
            ...
            <div class="reservation_contents">
                <div class="input_contents">
                    <div class="top">
                        ...
                        <p>Please select the date of arrival.</p>
                    </div>
                    <div class="bottom">
                ...
                <div class="input_contents">
                    <div class="top">
                        ...
                        <p>Please fill out the estimated arrival time.</p>
                    </div>
                    <div class="bottom">
                        <img src="../img/icon-time.jpg" class="time_icon" onclick="document.querySelector('.time').focus();">
                        <input type="time" name="time" class="time" onfocus="this.showPicker();" onchange="change_time(this.value)">
                    </div>
                </div>
                <div class="input_contents">
                    <div class="top">
                        <h2>Choose an airport</h2>
                        <p>Please choose the airport you want to arrive at</p>
                    </div>
                    <div class="bottom">
                        <select name="airport">
                            ...
                            while($row=mysqli_fetch_array($res)){
                                ?>
                            <option value="<?php echo $row['eng']?>"><?php echo $row['eng']?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="input_contents">
                    <div class="top">
                        ...
                        <p>Please enter the flight number of the plane you are taking.</p>
                    </div>
                    <div class="bottom">
                        <input type="text" name="flight_number" placeholder="Please enter the flight number of the plane">
                    </div>
                </div>
                <div class="input_contents hotel">
                    ...
                    <div class="bottom">
                        ...
                        <!-- <select name="hotel" onchange="hotel_change(this.value)">
                            <option value="" disabled selected>호텔을 선택해주세요</option>
                        </select> -->
                        <img src="../img/icon-search.png">
                        <input type="text" id="hotel" name="hotel" onkeyup="hotel_search(this.value)" placeholder="Please choose a hotel" class="hotel_input">
                        <div class="hotel_pop">
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="input_contents">
                    ...
                    <div class="bottom">
                        ...
                        <input type="time" name="arrive_time" class="hotel_time" onfocus="this.showPicker();" onchange="change_time(this.value)">
                    </div>
                    <p class="warning">Your hotel arrival time must be <b style="text-decoration: underline;">at least 3 hours</b> apart from your arrival time in Vietnam.</p>
                </div>
                <div class="input_contents hotel">
                    <div class="top">
                    ...
                    <div class="bottom">
                        <select name="payment_type">
                            ...
                            <option value="외부 결제 없음">No external payments</option>
                            <option value="몽키트레블">Monkeytravel</option>
                            <option value="마이리얼트립">Myrealtrip</option>
                            <option value="네이버스마트스토어">Naver smart store</option>
                        </select>
                    </div>
                </div>
                <div class="cargo_contents" style="margin-top: 40px;">
                    ...
                    <div class="right">
                        <h2>Quantity</h2>
                        <div class="quantity max_3">
                            <input type="number" name="basic_count" min="0" max="3" step="1" value="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="bottom_contents" style="margin-top: 40px;">
                    ...
                    <div class="right">
                        <input type="text" name="name_kor" placeholder="Korean" required>
                        <input type="text" name="name_eng" placeholder="English" required>
                    </div>
                </div>
            ...
            <div class="reservation_pop_btn">
                <a href="javascript:$('#sub').click();">VIEW ESTIMATE</a>
                <a href="javascript:keep_it()">SAVE</a>
            </div>
            <div class="keep_pop">
                <!-- <div class="close">
                    <span></span>
