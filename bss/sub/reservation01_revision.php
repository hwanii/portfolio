        ...
        <div class="inner">
            ...
            <div class="reservation_contents">
                    ...
                    <div class="bottom">
                        <select name="airport">
                            ...
                            while($row=mysqli_fetch_array($res)){
                                ...
                                $eng=$row['eng'];
                                ?>
                            <option value="<?php echo $row['eng']?>" <?php echo ($airport==$eng) ? "selected" : ""?>><?php echo $row['kor']?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="input_contents">
                    <div class="top">
                        <h2>비행기 편명 입력</h2>
                        <p>타고 오시는 비행기의 편명을 입력해주세요</p>
                    </div>
                    <div class="bottom">
                        <input type="text" name="flight_number" value="<?php echo $flight_number?>" placeholder="비행기 편명을 입력해주세요">
                    </div>
                </div>
                <div class="input_contents hotel">
                    <div class="top">
                        <h2>호텔 찾기</h2>
                        <p>도착하시는 호텔을 선택해주세요</p>
                    </div>
                    <div class="bottom">
                        ...
                        <img src="../img/icon-search.png">
                        <input type="text" id="hotel" name="hotel" value="<?php echo $hotel?>" onkeyup="hotel_search(this.value)" placeholder="호텔을 선택해주세요" class="hotel_input">
                        <div class="hotel_pop">
                            <p></p>
                        </div>
                    </div>
                ...
                <div class="input_contents">
                    ...
                    <p class="warning">호텔 도착 시간은 베트남 도착 시간과 <b style="text-decoration: underline;">최소 3시간</b>의 차이가 나야 합니다.</p>
                </div>
                <div class="input_contents hotel">
                    <div class="top">
                        <h2>외부 결제 선택</h2>
                ...
                <div class="cargo_contents" id="airport_box" style="<?php echo ($air_box==0) ? "display:none" : ""?>">
                    ...
                    <div class="right">
                        <p id="box"><?php echo number_format($air_box)?>원</p>
                    </div>
                </div>
