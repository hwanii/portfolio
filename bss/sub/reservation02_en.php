            ...
            <div class="reservation_contents">
                ...
                <div class="input_contents">
                    ...
                    <div class="bottom">
                        ...
                        <input type="time" name="time" class="time" onfocus="this.showPicker();">
                    </div>
                </div>
                <div class="input_contents">
                    <div class="top">
                ...
                <div class="input_contents hotel">
                    ...
                    <div class="bottom">
                        ...
                        <img src="../img/icon-search.png">
                        <input type="text" id="hotel_input1" name="hotel_from" onkeyup="hotel_search(this.value, '1')" placeholder="Please choose a hotel" class="hotel_input">
                ...
                <div class="input_contents hotel">
                    ...
                    <div class="bottom">
                        ...
                        <img src="../img/icon-search.png">
                        <input type="text" id="hotel_input2" name="hotel_arrive" onkeyup="hotel_search(this.value, '2')" placeholder="Please choose a hotel" class="hotel_input">
