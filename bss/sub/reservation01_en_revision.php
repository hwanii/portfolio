        ...
        <div class="inner">
            ...
            <div class="reservation_contents">
                    ...
                    <div class="bottom">
                        <select name="airport">
                            ...
                            while($row=mysqli_fetch_array($res)){
                                ?>
                            <option value="<?php echo $row['eng']?>" <?php echo ($airport==$eng) ? "selected" : ""?>><?php echo $row['eng']?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="input_contents">
                    ...
                    <div class="bottom">
                        <input type="text" name="flight_number" value="<?php echo $flight_number?>" placeholder="Please enter the flight number of the plane">
                    </div>
                </div>
                ...
                <div class="cargo_contents" id="hotel_add" style="<?php echo ($add==0) ? "display:none" : ""?>">
                    <div class="left">
