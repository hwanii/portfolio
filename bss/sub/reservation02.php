            ...
            <div class="reservation_contents">
                    ...
                    <div class="bottom">
                        <select name="city_from">
                            ...
                            while($row=mysqli_fetch_array($res)){
                                ?>
                            <option value="<?php echo $row['eng']?>"><?php echo $row['kor']." / ".$row['eng']?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="input_contents hotel">
                    ...
                    <div class="bottom">
                        ...
                        <img src="../img/icon-search.png">
                        <input type="text" id="hotel_input1" name="hotel_from" onkeyup="hotel_search(this.value, '1')" placeholder="호텔을 선택해주세요" class="hotel_input">
                ...
                <div class="input_contents">
                    ...
                    <p class="warning">호텔 도착 시간은 수하물 맡기는 시간과 <b style="text-decoration: underline;">최소 3시간</b>의 차이가 나야 합니다.</p>
                </div>
                <div class="input_contents hotel">
                    <div class="top">
                        <h2>호텔 찾기</h2>
                    ...
                    <div class="bottom">
                        ...
                        <img src="../img/icon-search.png">
                        <input type="text" id="hotel_input2" name="hotel_arrive" onkeyup="hotel_search(this.value, '2')" placeholder="호텔을 선택해주세요" class="hotel_input">
