...
<aside>
    ...
    <a href="<?php echo $root?>index_en.php">Baggage Storage Service</a>
    <div class="gnb">
        <a href="<?php echo $root?>sub/reservation_en.php">
            <p>RESERVATION</p>
            <div class="line"></div>
            <img src="<?php echo $root?>img/icon-main01.png">
        </a>
        <a href="<?php echo $root?>sub/search_en.php">
            <p>SEARCH</p>
            <div class="line"></div>
            <img src="<?php echo $root?>img/icon-main02.png">
        </a>
        <a href="<?php echo $root?>sub/process_en.php">
            <p>Upload photos</p>
            <div class="line"></div>
            <img src="<?php echo $root?>img/icon-main03.png">
        </a>
        <a href="<?php echo $root?>sub/ask_en.php">
            <p>ASK</p>
            <div class="line"></div>
