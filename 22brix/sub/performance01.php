...
<body>
    ...
    <section class="performance">
        <div class="inner">
            <?php
            $sql="SELECT * FROM performance WHERE `type`='edu'";
            ...
            <div class="title">
                <ul class="performance_cate">
                    <li><a href="../sub/performance.php">광고 대행</a></li>
                    <li class="on"><a href="../sub/performance01.php">교육 및 컨설팅</a></li>
            ...
            <div class="col_contents00 col_contents_position">
                <div>
                    <img src="../img/performance/edu/<?php echo $img1?>" alt="">
                    <div>
                ...
                <div>
                    <img src="../img/performance/edu/<?php echo $img2?>" alt="">
                    <div>
                ...
                <div>
                    <img src="../img/performance/edu/<?php echo $img3?>" alt="">
                    <div>
                ...
                <div>
                    <img src="../img/performance/edu/<?php echo $img4?>" alt="">
                    <div>
