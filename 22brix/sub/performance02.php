...
<body>
    ...
    <section class="performance">
        <div class="inner">
            <?php
            $sql="SELECT * FROM performance WHERE `type`='big'";
            ...
            <div class="title">
                <ul class="performance_cate">
                    ...
                    <li class="on"><a href="../sub/performance02.php">빅 데이터 분석</a></li>
                </ul>
                <p>
                <?php echo $contents?>
                </p>
            </div>
            <div class="col_contents01">
                <div>
                    <img src="../img/performance/big/<?php echo $img1?>" alt="">
                    <div>
                ...
                <div>
                    <img src="../img/performance/big/<?php echo $img2?>" alt="">
                    <div>
                ...
                <div>
                    <img src="../img/performance/big/<?php echo $img3?>" alt="">
                    <div>
                ...
                <div>
                    <img src="../img/performance/big/<?php echo $img4?>" alt="">
                    <div>
                        <h3><?php echo $img3_tit?></h3>
                        <p>
