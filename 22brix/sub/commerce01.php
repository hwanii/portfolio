...
<body>
    ...
    <section class="performance">
        <div class="inner">
            <?php
            $sql="SELECT * FROM commerce WHERE `type`='edu'";
            ...
            <div class="title">
                <ul class="performance_cate cate01">
                    <li><a href="../sub/commerce.php">운영 대행</a></li>
                    <li class="on"><a href="../sub/commerce01.php">교육 및 컨설팅</a></li>
                </ul>
                <p>
                <?php echo $contents?>
                </p>
            </div>
            <div class="col_contents02">
                <div>
                    <img src="../img/commerce/edu/<?php echo $img1?>" alt="">
                    <div class="center">
                ...
                <div>
                    <img src="../img/commerce/edu/<?php echo $img2?>" alt="">
                    <div class="center">
                ...
                <div>
                    <img src="../img/commerce/edu/<?php echo $img3?>" alt="">
                    <div class="center">
                ...
                <div>
                    <img src="../img/commerce/edu/<?php echo $img4?>" alt="">
                    <div class="center">
