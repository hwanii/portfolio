...
<body>
    ...
    <div class="login">
        ...
        <div class="contents">
            <h2>이용약관</h2>
            <div>
                제1조(목적)이 약관은 에스유스카우트 회사(전자상거래 사업자)가 운영하는 에스유스카우트 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련<br>
                ...
                제2조(정의)
                <br>
                ① “몰”이란 에스유스카우트 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화
        ...
        <div class="contents">
            <h2>이용약관</h2>
            <div>
                에스유스카우트(이하"회사라 합니다)은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을
