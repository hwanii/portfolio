    ...
    <section class="reference">
        <div class="inner1200">
            <div class="reference_category" data-aos="fade-up">
                ...
                <a href="../sub/refer_branding.php" class="on">브랜딩</a>
            ...
            <div class="reference_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM reference WHERE branding1!='' OR branding2!='' OR branding3!='' OR branding4!='' OR branding5!=''";
                ...
                $sql="SELECT * FROM reference WHERE branding1!='' OR branding2!='' OR branding3!='' OR branding4!='' OR branding5!='' ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="reference_post.php?num=<?php echo $num?>&type=branding" class="contents" data-aos="fade-up">
