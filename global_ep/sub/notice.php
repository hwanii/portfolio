    ...
    <section class="notice">
        <div class="inner960">
            <div class="commu_category" data-aos="fade-up">
                <a href="../sub/notice.php" class="on">공지사항</a>
            ...
            <div data-aos="fade-up">
                <div class="notice_contents">
                    ...
                    $sql="SELECT * FROM notice ORDER BY num DESC LIMIT $limit, $list";
                    ...
                    ?>
                    <div class="contents">
                        <a href="notice_post.php?num=<?php echo $num?>"><?php echo date("y.m.d", strtotime($write_time))?></a>
                        <a href="notice_post.php?num=<?php echo $num?>"><?php echo $title?></a>
                        <a href="notice_post.php?num=<?php echo $num?>"><?php echo number_format($hit)?></a>
                        <p><img src="../img/icon-save.png" style="<?php echo ($file) ? "" : "display:none"?>"></p>
                    </div>
                    <?php } ?>
                </div>
            </div>
        ...
        <div class="post_pagination">
            <?php if($block > 1){ ?>
            <a href="notice.php?page=1"><img src="../img/b-icon-p-p-arrow.png"></a>
            <a href="notice.php?page=<?php echo $b_start_page - 1 ?>"><img src="../img/b-icon-p-arrow.png"></a>
            <?php } ?>
            <div class="num">
                <?php 
                for($i=$b_start_page;$i<=$b_end_page;$i++){
		            if($page == $i){ // page 와 i 가 같으면 현재 페이지?>
                    <a href="jsvaciprt" class="on"><?php echo $i?></a>
                <?php } else { ?>
            ...
            ?>
            <a href="notice.php?page=<?php echo $b_end_page + 1 ?>"><img src="../img/b-icon-n-arrow.png"></a>
            <a href="notice.php?page=<?php echo $total_page?>"><img src="../img/b-icon-n-n-arrow.png"></a>
            <?php }  ?>
        </div>
    </section>
