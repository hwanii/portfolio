    ...
    <section class="reference">
        <div class="inner1200">
            <div class="reference_category" data-aos="fade-up">
                ...
                <a href="../sub/refer_b2b.php" class="on">B2B &amp; B2C</a>
            ...
            <div class="reference_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM reference WHERE bab1!='' OR bab2!='' OR bab3!='' OR bab4!='' OR bab5!=''";
                ...
                $sql="SELECT * FROM reference WHERE bab1!='' OR bab2!='' OR bab3!='' OR bab4!='' OR bab5!='' ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="reference_post.php?num=<?php echo $num?>&type=bab" class="contents" data-aos="fade-up">
