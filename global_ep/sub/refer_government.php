    ...
    <section class="reference">
        <div class="inner1200">
            <div class="reference_category" data-aos="fade-up">
                ...
                <a href="../sub/refer_marketing.php">마케팅</a>
                <a href="../sub/refer_b2b.php">B2B &amp; B2C</a>
                <a href="../sub/refer_government.php" class="on">정부지원사업</a>
            </div>
            <div class="reference_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM reference WHERE government1!='' OR government2!='' OR government3!='' OR government4!='' OR government5!=''";
                ...
                $sql="SELECT * FROM reference WHERE government1!='' OR government2!='' OR government3!='' OR government4!='' OR government5!='' ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="reference_post.php?num=<?php echo $num?>&type=government" class="contents" data-aos="fade-up">
