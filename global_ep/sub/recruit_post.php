...
<body class="wrap">
    ...
    $hSql="UPDATE guide SET hit=hit+1 WHERE num='$num'";
    ...
    <section class="post">
        <div class="inner960">
            ...
            <a href="recruit.php" class="go-list">목록</a>
            <?php
            ...
            $nTitle=$nRow['title'];
            ?>
            <a href="<?php echo ($prev) ? "recruit_post.php?num=".$prev : "javascript:void(0)"?>" class="before-txt">
                <span>이전글</span>
                <p><?php echo ($prev) ? $pTitle : "이전 글이 없습니다."?></p>
            </a>
            <a href="<?php echo ($next) ? "recruit_post.php?num=".$next : "javascript:void(0)"?>" class="next-txt">
                <span>다음글</span>
