    ...
    <section class="reference">
        <div class="inner1200">
            <div class="reference_category" data-aos="fade-up">
                <a href="../sub/reference.php" class="on">전체보기</a>
            ...
            <div class="reference_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM reference";
                ...
                $sql="SELECT * FROM reference ORDER BY num DESC LIMIT $limit, $list";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    $num=$row['num'];
                ?>
                <a href="reference_post.php?num=<?php echo $num?>" class="contents" data-aos="fade-up">
