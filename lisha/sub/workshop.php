    ...
    <section class="schedule">
        <div class="inner">
            ...
            <div class="contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM workshop";
                ...
                $sql="SELECT * FROM workshop ORDER BY num DESC LIMIT $limit, $list";
                ...
                <div class="content">
                    ...
                    <a href="workshop_detail.php?num=<?php echo $num?>">DETAIL INFO</a>
                </div>
                <?php } ?>
            </div>
            <div class="list-page">
