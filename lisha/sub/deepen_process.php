...
<body>
    ...
    <section class="sub_banner">
        <div class="txt_box">
            ...
            <span>HOME&nbsp;&nbsp;>&nbsp;&nbsp;교육 소개&nbsp;&nbsp;>&nbsp;&nbsp;심화 과정 커리큘럼</span>
        </div>
    </section>
    <div class="sub_category">
        <a href="../sub/ilpa.php">ILPA란</a>
        <a href="../sub/expert_process.php">전문가 과정 커리큘럼</a>
        <a href="../sub/deepen_process.php" class="on">심화 과정 커리큘럼</a>
    ...
    <div class="ilpa">
        <div class="inner">
            ...
            <div class="expert_contents">
                <?php
                $sql="SELECT * FROM deepen WHERE cate='필라테스'";
            ...
            <div class="expert_contents">
                <?php
                $sql="SELECT * FROM deepen WHERE cate='과정'";
                $res=mysqli_query($conn, $sql);
                while($row=mysqli_fetch_array($res)){
                    $title=$row['title'];
                    $contents=$row['contents'];
                ?>
                <div class="content" data-aos="fade-up">
                    <h2 style="background-color: #29a0d7;"><?php echo $title?></h2>
                    <div class="txt_box">
                        <div>
                            <h3 style="color: #29a0d7;">설명</h3>
                            <p>
                                <?php echo $contents?>
                            </p>
                        </div>
