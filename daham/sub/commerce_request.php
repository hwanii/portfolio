...
<body>
    ...
    <section class="request">
        <div class="inner">
            ...
            <div class="request_category">
                <a href="../sub/product_request.php">상품조사 신청</a>
                <a href="../sub/visit_request.php">방문단 신청</a>
                <a href="../sub/commerce_request.php" class="on">전자상거래 신청</a>
            </div>
            <div class="re_top">
                ...
                <a href="../sub/commerce_request_write.php">신청글 작성</a>
            </div>
            <div class="re_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM commerce";
                ...
                $sql="SELECT * FROM commerce ORDER BY num DESC LIMIT $limit, $list";
    ...
    <div class="pass_pop">
            ...
            <input type="hidden" id="type" name="type" value="commerce">
    ...
    function pw_chk(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data=="true"){
                    location.href="commerce_request_detail.php?num="+num+"&aw="+aw;
                } else if(data=="false"){
