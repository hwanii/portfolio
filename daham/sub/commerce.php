...
$sql="INSERT INTO commerce SET write_time=now(), `name`='$name', pass='$pass', email='$email', title='$title', contents='$contents', stat='미확인'{$f1}{$f2}";
...
if($res){
    ...
    <script>
        alert("신청이 완료되었습니다.");
        parent.location.href="commerce_request.php";
