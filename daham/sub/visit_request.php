...
<body>
    ...
    <section class="request">
        <div class="inner">
            ...
            <div class="request_category">
                ...
                <a href="../sub/visit_request.php" class="on">방문단 신청</a>
            ...
            <div class="re_top">
                ...
                <a href="../sub/visit_request_write.php">신청글 작성</a>
            </div>
            <div class="re_contents">
                ...
                $pSql="SELECT COUNT(*) AS cnt FROM visit";
                ...
                $sql="SELECT * FROM visit ORDER BY num DESC LIMIT $limit, $list";
    ...
    <div class="pass_pop">
        <form action="pw_chk.php">
            ...
            <input type="hidden" id="type" name="type" value="visit">
    ...
    function pw_chk(){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data=="true"){
                    location.href="visit_request_detail.php?num="+num+"&aw="+aw;
                } else if(data=="false"){
