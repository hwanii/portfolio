...
<body class="wrap">
    ...
    <section class="autocash">
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='hana_new'";
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='hana'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="table_contents">
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='woori'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="table_contents">
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='loca_new'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="table_contents">
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='loca'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="table_contents">
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='kb'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="table_contents">
        ...
        <div class="contents">
            ...
            <?php
            $sql="SELECT * FROM installment WHERE `type`='mycar'";
            $res=mysqli_query($conn, $sql);
            $row=mysqli_fetch_array($res);
            ?>
            <div class="table_contents">
