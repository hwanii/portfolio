...
<body>
    ...
    <section class="map" data-aos="fade-up">
        ...
        <div class="map-cate" data-aos="fade-up">
            <a href="../sub/map-01.php">본사</a>
            <a href="../sub/map-02.php" class="on">제주지사</a>
        </div>
        ...
        <div class="map-block" data-aos="fade-up">
            <div class="mapmap">
                <!-- * 카카오맵 - 지도퍼가기 -->
                <!-- 1. 지도 노드 -->
                <div id="daumRoughmapContainer1668736386474" class="root_daum_roughmap root_daum_roughmap_landing"></div>
