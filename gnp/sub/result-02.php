...
<body>
    ...
    <section class="gallery" data-aos="fade-up">
        <h2 data-aos="fade-up">태양광 발전사업</h2>
        ...
        <?php
            ...
            $pSql="SELECT COUNT(*) AS cnt FROM bo_sun";
            ...
            $sql="SELECT * FROM bo_sun ORDER BY num DESC LIMIT $limit, $list";
            ...
            ?>
            <div class="con">
                <a href="result-02-detail.php?num=<?php echo $num?>">
                    <img src="../img/file/sun/thumb/<?php echo $thumb?>" alt="">
                    <div>
