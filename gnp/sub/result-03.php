...
<body>
    ...
    <section class="gallery" data-aos="fade-up">
        ...
        <div class="inner" data-aos="fade-up">
            ...
            $pSql="SELECT COUNT(*) AS cnt FROM bo_shield";
            ...
            $sql="SELECT * FROM bo_shield ORDER BY num DESC LIMIT $limit, $list";
            ...
            ?>
            <div class="con">
                <a href="result-03-detail.php?num=<?php echo $num?>">
                    <img src="../img/file/shield/thumb/<?php echo $thumb?>" alt="">
                    <div>
